package com.gamesapiexternal.service.iam.infrastructure.authorization.sfs.configuration;

import com.gamesapiexternal.service.iam.infrastructure.authorization.sfs.pipeline.BearerAuthorizationRequestFilter;
import com.gamesapiexternal.service.iam.infrastructure.hashing.bcrypt.BCryptHashingService;
import com.gamesapiexternal.service.iam.infrastructure.tokens.jwt.BearerTokenService;
...
public class WebSecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors(configurer -> configurer.configurationSource(request  -> {
            ...
            cors.setAllowedOrigins(Arrays.asList("http://localhost:9095"));
            return cors;
        }));
